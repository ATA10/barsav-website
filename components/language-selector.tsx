...
//         className="flex items-center gap-2 px-3 py-2 rounded-full bg-card border border-[color:var(--border)] hover:border-accent transition text-foreground"
//         aria-label="Select language"
//         style={{ fontFamily: 'system-ui, -apple-system, "Segoe UI", "Noto Color Emoji", sans-serif' }}
//       >
...
//       {isOpen && (
//         <div className="absolute right-0 mt-2 w-44 bg-card border border-[color:var(--border)] rounded-lg shadow-lg z-50 overflow-hidden">
//           {languages.map((lang) => (
//             <button
//               key={lang.code}
//               onClick={() => {
