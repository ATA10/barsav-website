...
//   const [selectedSubCategory, setSelectedSubCategory] = useState<string>("") // Added subCategory state
...
//     setSelectedSubCategory("") // Reset subCategory when language changes
//   }, [language])
...
//     if (category === allCategory) return []
...
//           <h1 className="text-5xl sm:text-6xl font-bold text-foreground mb-6 text-balance text-white">
//             {getTranslation(language, "products.title")}
//           </h1>
//           <p className="text-xl text-white text-balance">{getTranslation(language, "products.subtitle")}</p>
//         </div>
//       </section>
...
//                       : "bg-muted border border-[color:var(--border)] text-muted-foreground hover:border-accent"
//                   }`}
//                 >
//                   Tümü
//                 </button>
...
//               <p className="text-xl text-muted-foreground">{getTranslation(language, "products.notFound")}</p>
//             </div>
//           ) : (
