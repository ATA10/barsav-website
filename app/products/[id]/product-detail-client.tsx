...
// //   const [showNav, setShowNav] = useState(false)
// //   const [selectedImageIndex, setSelectedImageIndex] = useState(0)
// //   const [isZoomed, setIsZoomed] = useState(false) // Added zoom state
// //   const [zoomPosition, setZoomPosition] = useState({ x: 0, y: 0 }) // Added zoom position
...
// //             <div>
// //               <div
// //                 className="relative w-full h-96 mb-4 rounded-lg overflow-hidden bg-card border border-[color:var(--border)] cursor-zoom-in"
...
//             <div>
//               <div
//                 className="relative w-full h-96 mb-4 rounded-lg overflow-hidden bg-card border border-[color:var(--border)] cursor-pointer"
//                 onMouseEnter={() => setIsZoomed(true)}
//                 onMouseLeave={() => setIsZoomed(false)}
//                 onMouseMove={handleMouseMove}
...
const defaultDocuments = [
  {
    title: "Barsav Havacılık - Firma Tanıtım Kataloğu",
    file: "/documents/barsav-tanitim-tr.pdf",
  },
  {
    title: "Barsav Company Profile",
    file: "/documents/barsav-company-en.pdf",
  },
]
